...
class Gallery
{
     ...
     * Add gallery_images
     *
     * @param \Iog\AdminBundle\Entity\Image $galleryImages
     * @return Gallery
     */
    public function addGalleryImage(\Iog\AdminBundle\Entity\Image $galleryImages)
    {
     ...
     * @param \Iog\AdminBundle\Entity\Image $galleryImages
     */
    public function removeGalleryImage(\Iog\AdminBundle\Entity\Image $galleryImages)
    {
