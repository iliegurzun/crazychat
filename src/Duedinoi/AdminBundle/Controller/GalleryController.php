...
class GalleryController extends Controller
{
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        return $this->render('DuedinoiAdminBundle:Gallery:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DuedinoiAdminBundle:Gallery:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $gallery = $em->getRepository('DuedinoiAdminBundle:Gallery')->find($gallery_id);
...
//                    $content = $request->request->get('description');
                    ...
                    $file->htmlTemplate = $this->renderView('DuedinoiAdminBundle:Gallery:single_image.html.twig', array('image' => $image, 'gallery' => $gallery));
                }
            }
        }
    ...
    public function removeImageAction(Request $request)
    {
        ...
        if($request->isMethod('post')) {
            ...
            $image = $em->getRepository('DuedinoiAdminBundle:Image')->find($image);
            $gallery = $request->request->get('gallery_id');
            $gallery = $em->getRepository('DuedinoiAdminBundle:Gallery')->find($gallery);
...
//            $em->remove($image);
    ...
    public function updateImageDescAction($image_id, Request $request)
    {
        ...
        $image = $em->getRepository('DuedinoiAdminBundle:Image')->find($image_id);
